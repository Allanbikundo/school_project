...
public class Pamvotis extends JFrame {
    ...
    class NtConfFilter extends FileFilter {
        ...
        public boolean accept(File f) {
            ...
            if (extension != null) {
                if (extension.endsWith("xls") || extension.endsWith("txt")) {
                    return true;
        ...
        public String getDescription() {
            return "Network Configuration Filtering";
        }
    }
    ...
    private void initialize() {
        ...
        this.setIconImage(Toolkit.getDefaultToolkit().getImage("icons" + File.separator + "logo.jpg"));
    ...
    private JPanel getJContentPane() {
        if (jContentPane == null) {
            ...
            jLblPamv.setIcon(new ImageIcon("icons" + File.separator + "pamvotis.jpg"));
            jLblPamv.setText("");
            jLblTime = new JLabel();
